...
BBYield = read_xlsx(file.path(DATA_RAW, "INDYC_3mo30y.xlsx"), range = 'A3:T1657')      # Data available for some variables upto 1998. But, importing data from 2018 Jan
...
#Importing OIS rates
OISYield = read_xlsx(file.path(DATA_RAW,"/IND_OIS_1mo1y.xlsx"), range = 'A3:F1662')      # Data available for some variables upto 1998. But, importing data from 2018 Jan
